    ...
    <div class="container-fluid homeJumbotron">
        <div class="container d-flex flex-column mt-5 pt-5">
            ...
            <a href="#mobil-untuk-anda"
                class="tombolSelengkapnya d-flex align-items-center justify-content-center px-3">SELENGKAPNYA<i
    ...
    <div class="container mt-3">
        <div class="row gx-5">
            ...
            <div class="col-lg-8 col-md-12 listMobil ms-lg-3 mt-3">
                <div class="row">
                    <div class="jumlahMobil d-flex align-items-center p-3">{{ $jumlah->jumlah }} Mobil</div>
                </div>
                @foreach ($data as $row)
                    <div class="row cardMobil mt-3 p-2">
                        <div class="col-md">
                            <img src="{{ asset($row->foto_kendaraan) }}" class="img-fluid w-100 mx-auto" alt="" />
                        </div>
                        <div class="col-md p-3">
                            <h1 class="merekMobil fw-3">{{ $row->nama_brand }}, {{ $row->nama_merek }}</h1>
                            <p class="hargaMobil">Rp. {{ number_format($row->harga_sewa, 0, ',', '.') }} / Hari</p>
                            <div class="row my-3 infoMobil">
                                <div class="col"><i class="uil uil-user me-2"></i>{{ $row->jumlah_tersedia }} Tersedia
                                </div>
                                <div class="col"><i class="uil uil-pump me-2"></i>{{ $row->bahan_bakar }}</div>
                                <div class="col"></div>
                            </div>
                            <a href="{{ asset('detil/' . $row->id) }}" class="lihatDetilKendaraan py-2 px-3 mt-4"> Lihat
