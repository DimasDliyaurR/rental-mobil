                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="overflow-visible" style="width: 10wv">
                                ...
                                @endif
                                <form action="{{ asset('/pengeluaran-update/update') }}" method="POST">
                                    @csrf
                                    {{-- Nama Pengeluaran --}}
                                    ...
                                    <div class="mb-3">
                                        <div class="col-md-6 form-floating">
                                            ...
                                            <textarea oninput="this.value = this.value.toLowerCase()" class="form-control @error('deskripsi_pengeluaran') is-invalid @enderror"
                                                ...
                                                style="height: 100px">{{ $data->deskripsi_pengeluaran }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        <div class="col-md-6 form-floating">
                                            <input type="text" id="harga_pengeluaran" name="harga_pengeluaran"
                                                class="form-control @error('harga_pengeluaran') is-invalid @enderror" value="{{ $data->harga_pengeluaran }}"
