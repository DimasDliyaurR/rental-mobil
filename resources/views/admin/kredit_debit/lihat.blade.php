                        ...
                        <div class="card-header">
                            <div class="d-flex flex-fill justify-content-end">
                                <form action="/kredit-debit">
                                    ...
                                    <input class="form-control form-control-lg" type="month" id="bulanTahun" name="bulanTahun">
                            ...
                            <h3 class="mt-4 text-center fw-bold">{{ $title }}</h3>
                                ...
                                <table class="table table-bordered mx-auto" style="width: 70%">
                                    ...
                                    @foreach ($transaksi as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">Rp. {{ number_format($row->jumlah_transaksi, 0, ',', '.') }},-</td>
                                            <td></td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                    ...
                                    @foreach ($pengeluaran as $row)
                                        <tr>
                                            ...
                                            <td></td>
                                            <td class="text-center">Rp. {{ number_format($row->harga_pengeluaran, 0, ',', '.') }},-</td>
                                        </tr>
                                    @endforeach

                                    <tr>
                                        <th class="text-center">Total</th>
                                        <th class="text-center">Rp. {{ number_format($total_transaksi, 0, ',', '.') }},-</th>
                                        <th class="text-center">Rp. {{ number_format($total_pengeluaran->total_pengeluaran, 0, ',', '.') }},-</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center">Debit - Kredit</th>
                                        <th class="text-center" colspan="2">Rp. {{ number_format($debit_kredit, 0, ',', '.') }},-</th>
                                    </tr>
                                    @else
                                        <tr>
